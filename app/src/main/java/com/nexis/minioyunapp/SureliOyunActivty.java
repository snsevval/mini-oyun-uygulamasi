...
public class SureliOyunActivty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sureli_oyun_activty);
    ...
    public void btnTekrarOynaS(View v){
        Intent tekrarOyna = new Intent(this, SureliOyunActivty.class);
        finish();
